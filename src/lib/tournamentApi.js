...
export async function markWalkover(matchId, { kind, loser, justified = null }) {
  // Só os quatro campos: desistir é perder o jogo inteiro, o resultado até
  // ali não conta (Francisco, 23 set — Trello #458). Sem p_score_*, a
  // mark_walkover dá a falta cheia (0 contra o máximo), como na falta.
